...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative bg-neutral-800 pt-24 min-h-screen">
      <div className="absolute inset-0 bg-[url('/background/orchestra-violins.jpg')] bg-cover bg-center opacity-80 mix-blend-overlay" />
